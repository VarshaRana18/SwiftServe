                ...
                <div className="p-8">
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        ...
                        <button
                            ...
                            className="w-full py-3.5 mt-2 text-white bg-orange-500 rounded-xl hover:bg-orange-600 font-bold shadow-lg shadow-orange-200 transition-all active:scale-95 disabled:opacity-70"
                        >
