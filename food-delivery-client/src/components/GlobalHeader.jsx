            ...
            <header className="sticky top-0 z-40 bg-white border-b border-slate-100 shadow-sm">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-4">
                    <div className="flex items-center gap-6">
                        ...
                        {/* The Restored & Interactive Location Pill */}
                        <button 
                            onClick={() => setIsLocationModalOpen(true)} 
                            className="hidden md:flex items-center gap-2 bg-slate-50 hover:bg-slate-100 border border-slate-200 px-4 py-2.5 rounded-full transition-all active:scale-95"
                        >
                    ...
                    <div className="flex-1 max-w-xl relative">
                        ...
                        {/* The Restored Search Results Overlay */}
                                    ...
                                    {searchResults.length > 0 ? (
                                        searchResults.map(result => (
                                            <button 
                                                ...
                                                className="w-full text-left px-3 py-3 hover:bg-slate-50 rounded-lg flex items-center justify-between transition-colors"
                                            >
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="relative">
                                <input 
                                    ...
                                    className="w-full bg-slate-50 border border-slate-200 text-slate-800 rounded-xl pl-11 pr-4 py-3.5 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:bg-white transition-all font-medium" 
                                />
                            ...
                            <button 
                                onClick={() => { setActiveLocation("Current Location"); setIsLocationModalOpen(false); }} 
                                className="w-full flex items-center gap-4 p-4 rounded-2xl bg-orange-50/50 hover:bg-orange-50 transition-colors border border-orange-100 group text-left"
                            >
